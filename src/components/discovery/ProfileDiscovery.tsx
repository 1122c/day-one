  ...
  const mockProfiles: UserProfile[] = [
    {
      ...
      name: 'Emma Rodriguez',
      bio: 'Software engineer passionate about building inclusive technology and mentoring junior developers.',
      values: {
        coreValues: ['Growth', 'Empathy', 'Innovation'],
        personalGoals: ['Mentorship', 'Learning'],
    ...
    },
    {
      ...
      name: 'Michael Chang',
      bio: 'Product designer focused on creating user-centered experiences that solve real problems.',
      values: {
        coreValues: ['Authenticity', 'Collaboration', 'Purpose'],
        personalGoals: ['Professional Networking', 'Support'],
        preferredCommunication: ['In-Person Meetings', 'Video Calls'],
        availability: {
          timezone: 'EST',
    ...
    },
    {
      ...
      name: 'Jessica Kim',
      bio: 'Marketing strategist helping brands build authentic connections with their audiences.',
      values: {
        coreValues: ['Connection', 'Authenticity', 'Balance'],
        personalGoals: ['Professional Networking', 'Collaboration'],
        preferredCommunication: ['Text Chat', 'Voice Calls'],
        availability: {
          timezone: 'CST',
